...
public class BattleMap extends JPanel {
    ...
    private void mouseReleasedUpdate(MouseEvent e) {
        ...
        if (Logic.checkWinLines(Logic.DOT_X) || Logic.checkWinLines(Logic.DOT_O) || Logic.isFull()) {
            JOptionPane.showMessageDialog(null, Logic.gameOverMessage, "Game Result",
    ...
    private void drawX(Graphics g, int cellX, int cellY) {
        ...
        g.drawLine(cellX * cellWidth, cellY * cellHeight, (cellX + 1) * cellWidth,
                (cellY + 1) * cellHeight);
        g.drawLine((cellX + 1) * cellWidth, cellY * cellHeight, cellX * cellWidth,
                (cellY + 1) * cellHeight);
    }
